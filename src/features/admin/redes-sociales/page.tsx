    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <AdminHeader
          ...
          right={<Button onClick={crearRed}>➕ Agregar Red Social</Button>}
        />
              ...
              <div className={`p-4 ${red.activo ? 'bg-gradient-to-r from-fuchsia-600 to-purple-700' : 'bg-slate-700/70'}`}>
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`text-xs px-2 py-1 rounded-md border backdrop-blur-sm ${red.activo ? 'bg-white/20 text-white border-white/20' : 'bg-slate-800/50 text-slate-300 border-slate-600/40'}`}
                  >
